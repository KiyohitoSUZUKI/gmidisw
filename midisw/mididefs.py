...
class MIDIDef(dict):
     ...
     ## reverse-reference
     def rref(self, name): 
          return list(self.keys())[ list(self.values()).index(name) ]
...
class MIDIInstDef(object):
     ...
     def define(self,name):
          ...
          self.profiles[name] = {
               ...
               #
               "tones" : {
                    "banks" : {},     # {(bank_msb,bank_lsb): bank_name,... }
                    "programs" : {},  # {(bank_msb,bank_lsb,prog_no): [program_name category_name],...}
                    "categories": {}, # (category_name: [(msb,lsb,prg) ...], ....)
               },
               "drums" : {
                    "channels" : [],  # acceptable drum channels
                    "banks"    : {},  # (msb,lsb): "bankname"
                    "programs" : {},  # 
                    "categories": {}, #
                    "maps"     : {},  # {(msb,lsb,prg) : {note#: "insturuments",...}....}
               }
